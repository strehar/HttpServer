...
namespace Feri.MS.Parts.I2C.ADC
{
    internal class ADS1115Helper
    {
        internal I2cDevice I2cController { get; set; }
        internal ADS1115 Part { get; set; }
    ...
    class ADS1115 : IDisposable
    {
        ...
        private static Dictionary<int, ADS1115Helper> _initialized { get; set; } = new Dictionary<int, ADS1115Helper>();
        public int Address { get; set; } = 0;

        private ADS1115(int address)
        {
            Address = address;
        }

        public static ADS1115 Create(int address = 0x48, string i2cControllerDeviceId = null)
        {
            ...
            if (!_initialized.ContainsKey(address))
            {
                ...
                _part = new ADS1115(address);
                ADS1115Helper helper = new ADS1115Helper();
