...
{
    internal class PCA9685Helper
    {
        internal I2cDevice I2cController { get; set; }
        internal PCA9685 Part { get; set; }
    ...
    class PCA9685 : IDisposable
    {
        ...
        private static Dictionary<int, PCA9685Helper> _initialized { get; set; } = new Dictionary<int, PCA9685Helper>();
        public int Address { get; set; } = 0;

        private PCA9685(int address)
        {
            Address = address;
        }

        public static PCA9685 Create(int address = 0x48, string i2cControllerDeviceId = null)
        {
            ...
            if (!_initialized.ContainsKey(address))
            {
                ...
                _part = new PCA9685(address);
                PCA9685Helper helper = new PCA9685Helper();
