#region Changes
/*
Changed by Miha Strehar in 2016, changed:
Added using System.Reflection;
obj.GetType().IsPrimitive to obj.GetType().GetTypeInfo().IsPrimitive
obj.GetType().GetCustomAttributes to obj.GetType().GetTypeInfo().GetCustomAttributes
*/
#endregion
