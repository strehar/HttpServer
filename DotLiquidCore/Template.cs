...
namespace DotLiquidCore
{
	...
	public class Template
	{
		...
		/// <summary>
		/// Registers a simple type. DotLiquidCore will wrap the object in a <see cref="DropProxy"/> object.
		/// </summary>
		...
		{
			source = DotLiquidCore.Tags.Literal.FromShortHand(source);
			source = DotLiquidCore.Tags.Comment.FromShortHand(source);
